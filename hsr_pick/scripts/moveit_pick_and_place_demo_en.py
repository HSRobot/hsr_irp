...
class MoveItDemo:
    def __init__(self):
       ...
       # pick_gripper.go()
        ...
        table_pose.pose.position.y = -0.4 - 0.2
        ...
        box1_pose.pose.position.y = -0.5 - 0.2
        ...
        box2_pose.pose.position.y = -0.27 - 0.2
        ...
        target_pose.pose.position.y = -0.4 - 0.2
        ...
        place_pose.pose.position.y = -0.18 - 0.2
