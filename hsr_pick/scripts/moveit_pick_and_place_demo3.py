...
# GRIPPER_JOINT_NAMES = ['pick_gripper_finger_joint']
...
TARGET_QUATERNION_X = 0.0
TARGET_QUATERNION_Y = 0.707
TARGET_QUATERNION_Z = 0.0
TARGET_QUATERNION_W = 0.707
...
class MoveItDemo:
    def __init__(self):
       ...
       # pick_gripper.go()
        ...
        base_table_pose.pose.position.z = 0 - table_size[2] / 2.0
        ...
        box1_pose.pose.position.x = 0.46
        ...
        box2_pose.pose.position.x = 0.44
        box2_pose.pose.position.y = -0.27
        ...
        target_pose.pose.orientation.x = TARGET_QUATERNION_X
        target_pose.pose.orientation.y = TARGET_QUATERNION_Y
        target_pose.pose.orientation.z = TARGET_QUATERNION_Z
        target_pose.pose.orientation.w = TARGET_QUATERNION_W
        ...
        place_pose.pose.position.x = 0.43
    ...
    def make_grasps(self, initial_pose_stamped, allowed_touch_objects):
        ...
        # Get RPY
        q_temp =(TARGET_QUATERNION_X,TARGET_QUATERNION_Y,TARGET_QUATERNION_Z,TARGET_QUATERNION_W)
        euler_temp = euler_from_quaternion(q_temp)

        # Pitch angles to try
        #pitch_vals = [0, 0.1, -0.1, 0.2, -0.2, 0.3, -0.3]
        #pitch_vals = [1.57,1.57,1.57,1.57,1.57,1.57,1.57]        
        #pitch_vals = [1.57, 1.67, 1.47, 1.77, 1.37, 1.87, 1.27]
        pitch_vals = [euler_temp[1], 
                      euler_temp[1] - 0.1, 
                      euler_temp[1] - 0.15,
                      euler_temp[1] - 0.2,
                      euler_temp[1] - 0.25,
                      euler_temp[1] - 0.30,
                      euler_temp[1] - 0.35]
        rospy.loginfo("euler_temp[1]: " +  str(euler_temp[1]))

        # Yaw angles to try
        yaw_vals = [euler_temp[2],euler_temp[2],euler_temp[2],euler_temp[2],euler_temp[2],euler_temp[2],euler_temp[2]]
        ...
        for y in yaw_vals:
            for p in pitch_vals:
                ...
                q = quaternion_from_euler(euler_temp[0], p, y)
