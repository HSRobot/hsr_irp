...
scene.remove_world_object(s_table_id)
scene.remove_world_object(s_scene_id)
...
s_table_size = [0.7, 1.5, 0.01]
s_scene_size = [0.055, 0.055, 0.11]
...
left_wall_pose.pose.position.y = -1.0
...
right_wall_pose.pose.position.y = 1.0
...
foreward_wall_pose.pose.position.x = 1.0
...
backward_wall_pose.pose.position.x = -1.0
...
# Add a backward_wall to the scene
s_table_pose = PoseStamped()
s_table_pose.header.frame_id = REFERENCE_FRAME
s_table_pose.pose.position.x = 0.80
s_table_pose.pose.position.y = 0.0
s_table_pose.pose.position.z = TABLE_GROUND +1.0#-0.45
s_table_pose.pose.orientation.w = 1.0
scene.add_box(s_table_id, s_table_pose, s_table_size)

# Add a backward_wall to the scene
s_scene_pose = PoseStamped()
s_scene_pose.header.frame_id = REFERENCE_FRAME
s_scene_pose.pose.position.x = 0.78
s_scene_pose.pose.position.y = 0.132
s_scene_pose.pose.position.z = TABLE_GROUND +1.057
s_scene_pose.pose.orientation.w = 1.0
scene.add_box(s_scene_id, s_scene_pose, s_scene_size)
