...
class MoveItDemo:
    def __init__(self):
        ...
        self.gripper_pose_pub = rospy.Publisher('gripper_pose', PoseStamped, queue_size=1)
       ...
       # pick_gripper.go()
        ...
        base_table_pose.pose.position.z = -0.5
        ...
        target_pose.pose.position.x = 0.61
        ...
        table_pose.pose.position.z =  target_pose.pose.position.z - (target_size[2] / 2)
        table_pose.pose.orientation.w = 1.0
        scene.add_box(table_id, table_pose, table_size)
        
        box1_pose = PoseStamped()
        box1_pose.header.frame_id = REFERENCE_FRAME
        box1_pose.pose.position.x = table_pose.pose.position.x
        box1_pose.pose.position.y = table_pose.pose.position.y - 0.1
        box1_pose.pose.position.z =  table_pose.pose.position.z + box1_size[2] / 2
        box1_pose.pose.orientation.w = 1.0   
        scene.add_box(box1_id, box1_pose, box1_size)
        
        box2_pose = PoseStamped()
        box2_pose.header.frame_id = REFERENCE_FRAME
        box2_pose.pose.position.x = table_pose.pose.position.x
        box2_pose.pose.position.y = table_pose.pose.position.y + 0.1
        box2_pose.pose.position.z = table_pose.pose.position.z + box2_size[2] / 2
        ...
        place_pose.pose.position.y = target_pose.pose.position.y - 0.3
        ...
        while result != MoveItErrorCodes.SUCCESS and n_attempts < max_pick_attempts and not rospy.core.is_shutdown():
            n_attempts += 1
        ...
        if result == MoveItErrorCodes.SUCCESS:
            ...
            # Repeat until we succeed or run out of attempts
            while result != MoveItErrorCodes.SUCCESS and n_attempts < max_place_attempts and not rospy.core.is_shutdown():
                n_attempts += 1
...
def shutdown():
    rospy.loginfo("Stopping pick and place")
    os._exit(0)
